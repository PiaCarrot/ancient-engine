...
Moves1:
	...
	move EFFECT_DEFENSE_UP_2,        0, PSYCHIC,  STATUS,   100, 30,   0 ;BARRIER
	...
	move EFFECT_PSYWAVE,             1, PSYCHIC,  SPECIAL,   80, 15,   0 ;PSYWAVE
	...
	move EFFECT_FUTURE_SIGHT,       80, PSYCHIC,  SPECIAL,   90, 15,   0 ;FUTURE_SIGHT
...
;==========================
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; UPROAR
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; STOCKPILE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SPIT_UP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SWALLOW
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEAT_WAVE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HAIL
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TORMENT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FLATTER 
	move EFFECT_NORMAL_HIT,                 0, FIRE,     STATUS,    85, 15,   0 ; WILL_O_WISP EFFECT_BURN 
	move EFFECT_NORMAL_HIT,              0, DARK,     STATUS,   100, 10,   0 ; MEMENTO EFFECT_MEMENTO
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FACADE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FOCUS_PUNCH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SMELLINGSALT 
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; NATURE_POWER
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TRICK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ROLE_PLAY
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; WISH
	move EFFECT_NORMAL_HIT,               0, NORMAL,   STATUS,   100, 20,   0 ; ASSIST EFFECT_ASSIST
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; INGRAIN
	move EFFECT_NORMAL_HIT,         120, FIGHTING, PHYSICAL, 100,  5,   0 ; SUPERPOWER EFFECT_SUPERPOWER
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MAGIC_COAT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; RECYCLE
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; YAWN
	move EFFECT_NORMAL_HIT,           65, DARK,     PHYSICAL, 100, 20,   0 ; KNOCK_OFF EFFECT_KNOCK_OFF
	move EFFECT_NORMAL_HIT,             1, NORMAL,   PHYSICAL, 100,  5,   0 ; ENDEAVOR EFFECT_ENDEAVOR
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ERUPTION
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SKILL_SWAP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; IMPRISON
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; REFRESH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GRUDGE
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CAMOUFLAGE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TAIL_GLOW
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LUSTER_PURGE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MIST_BALL
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FEATHER_DANCE
	move EFFECT_CONFUSE,              0, NORMAL,   STATUS,   100, 20,   0 ; TEETER_DANCE
	move EFFECT_BURN_HIT,            85, FIRE,     PHYSICAL,  90, 10,  10 ; BLAZE_KICK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MUD_SPORT 
	move EFFECT_ROLLOUT,             30, ICE,      PHYSICAL,  90, 20,   0 ; ICE_BALL
	move EFFECT_FLINCH_HIT,          60, GRASS,    PHYSICAL, 100, 15,  30 ; NEEDLE_ARM
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SLACK_OFF
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HYPER_VOICE
	move EFFECT_NORMAL_HIT,           50, POISON,   PHYSICAL, 100, 15,  50 ; POISON_FANG EFFECT_TOXIC_HIT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CRUSH_CLAW
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BLAST_BURN
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HYDRO_CANNON
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; WEATHER_BALL
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; AROMATHERAPY
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FAKE_TEARS
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SILVER_WIND
	move EFFECT_NORMAL_HIT,        0, STEEL,    STATUS,    85, 40,   0 ; METAL_SOUND EFFECT_SP_DEF_DOWN_2
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GRASSWHISTLE
	move EFFECT_NORMAL_HIT,               0, NORMAL,   STATUS,   100, 20,   0 ; TICKLE EFFECT_TICKLE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; COSMIC_POWER
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SKY_UPPERCUT
	move EFFECT_TRAP_TARGET,         35, GROUND,   PHYSICAL,  85, 15,   0 ; SAND_TOMB
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SHEER_COLD
	move EFFECT_ACCURACY_DOWN_HIT,   90, WATER,    SPECIAL,   85, 10,  30 ; MUDDY_WATER
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BULLET_SEED
	move EFFECT_ALWAYS_HIT,          60, FLYING,   PHYSICAL, 100, 20,   0 ; AERIAL_ACE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ICICLE_SPEAR
	move EFFECT_DEFENSE_UP_2,        0, STEEL,     STATUS,   100, 16,   0 ; IRON_DEFENSE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BLOCK
	move EFFECT_ATTACK_UP,           0, NORMAL,    STATUS,   100, 40,   0 ; HOWL
	move EFFECT_NORMAL_HIT,          80, DRAGON,   PHYSICAL, 100, 15,   0 ; DRAGON_CLAW
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FRENZY_PLANT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BULK_UP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BOUNCE
	move EFFECT_SPEED_DOWN_HIT,      55, GROUND,   SPECIAL,   95, 15, 100 ; MUD_SHOT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; POISON_TAIL
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MAGICAL_LEAF
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; WATER_SPORT
	move EFFECT_NORMAL_HIT,            0, PSYCHIC,  STATUS,   100, 20,   0 ; CALM_MIND EFFECT_CALM_MIND
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LEAF_BLADE
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; DOOM_DESIRE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; PSYCHO_BOOST
	move EFFECT_NORMAL_HIT,               0, FLYING,    STATUS,   100, 10,   0 ; ROOST EFFECT_ROOST
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GRAVITY
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MIRACLE_EYE
	move EFFECT_NORMAL_HIT,        70, FIGHTING, PHYSICAL, 100, 10, 100 ; WAKE_UP_SLAP EFFECT_WAKE_UP_SLAP
	move EFFECT_NORMAL_HIT, 100, FIGHTING, PHYSICAL, 90, 10, 100 ; HAMMER_ARM EFFECT_SELF_SPEED_DOWN_HIT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GYRO_BALL
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEALING_WISH
	move EFFECT_NORMAL_HIT,               65, WATER,    SPECIAL,  100, 10,   0 ; BRINE EFFECT_BRINE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; NATURAL_GIFT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FEINT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; PLUCK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TAILWIND
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ACUPRESSURE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; METAL_BURST
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; U_TURN
	move EFFECT_NORMAL_HIT,       120, FIGHTING, PHYSICAL, 100,  5,   0 ; CLOSE_COMBAT EFFECT_CLOSE_COMBAT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; PAYBACK
	move EFFECT_NORMAL_HIT,           60, DARK,     PHYSICAL, 100, 10,   0 ; ASSURANCE EFFECT_ASSURANCE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; EMBARGO
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FLING
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; PSYCHO_SHIFT
	move EFFECT_NORMAL_HIT,           1, NORMAL,   SPECIAL,  100,  5,   0 ; TRUMP_CARD EFFECT_TRUMP_CARD
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEAL_BLOCK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; WRING_OUT 
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; POWER_TRICK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GASTRO_ACID
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LUCKY_CHANT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ME_FIRST 
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; COPYCAT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; POWER_SWAP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GUARD_SWAP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; PUNISHMENT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LAST_RESORT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; WORRY_SEED
	move EFFECT_NORMAL_HIT,        70, DARK,     PHYSICAL, 100,  5,   0 ; SUCKER_PUNCH EFFECT_SUCKER_PUNCH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TOXIC_SPIKES
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEART_SWAP
	move EFFECT_NORMAL_HIT,            0, WATER,    STATUS,   100, 20, 100 ; AQUA_RING EFFECT_AQUA_RING
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MAGNET_RISE
	move EFFECT_NORMAL_HIT,        120, FIRE,     PHYSICAL, 100, 15,  10 ; FLARE_BLITZ EFFECT_FLARE_BLITZ
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; FORCE_PALM
	move EFFECT_ALWAYS_HIT,          80, FIGHTING, SPECIAL,  100, 20,   0 ; AURA_SPHERE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ROCK_POLISH
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; AQUA_TAIL
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SEED_BOMB
	move EFFECT_FLINCH_HIT,          75, FLYING,   PHYSICAL,  95, 15,  30 ; AIR_SLASH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; X_SCISSOR
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SWITCHEROO
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GIGA_IMPACT
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; AVALANCHE
	move EFFECT_PRIORITY_HIT,        40, ICE,      PHYSICAL, 100, 30,   0 ; ICE_SHARD
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SHADOW_CLAW
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; THUNDER_FANG
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ICE_FANG
	...
	move EFFECT_FLINCH_HIT,          70, PSYCHIC,  PHYSICAL,  90, 15,  20 ; ZEN_HEADBUTT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MIRROR_SHOT
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; DEFOG
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; TRICK_ROOM
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LAVA_PLUME
	move EFFECT_NORMAL_HIT, 140, GRASS,   SPECIAL,   90,  5,   0 ; LEAF_STORM EFFECT_SELF_SPATK_DN_2_HIT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; POWER_WHIP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ROCK_WRECKER
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CROSS_POISON
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; GUNK_SHOT
	move EFFECT_FLINCH_HIT,          80, STEEL,    PHYSICAL, 100, 15,  30 ; IRON_HEAD
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MAGNET_BOMB
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; STONE_EDGE 
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CAPTIVATE 
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; STEALTH_ROCK 
	move EFFECT_NORMAL_HIT,           1, GRASS,    SPECIAL,  100, 20,   0 ; GRASS_KNOT EFFECT_GRASS_KNOT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CHATTER  
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; JUDGEMENT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; BUG_BITE
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; DEFEND_ORDER
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEAL_ORDER
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; HEAD_SMASH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; DOUBLE_HIT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; ROAR_OF_TIME
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SPACIAL_REND
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LUNAR_DANCE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CRUSH_GRIP
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; MAGMA_STORM
	move EFFECT_SLEEP,                0, DARK,     STATUS,    80, 10,   0 ; DARK_VOID
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SEED_FLARE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; OMINOUS_WIND
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; SHADOW_FORCE
