...
;==========================
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 35,   0 ; UPROAR
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; STOCKPILE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 35,   0 ; SPIT_UP
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; SWALLOW
	move EFFECT_BURN_HIT,            95, FIRE,     SPECIAL,   90, 10,  10 ; HEAT_WAVE
	move EFFECT_RAIN_DANCE,           0, ICE,      STATUS,   100, 10,   0 ; HAIL EFFECT_HAIL
	move EFFECT_NORMAL_HIT,           0, DARK,     STATUS,   100, 35,   0 ; TORMENT
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; TRICK
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; ROLE_PLAY
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; WISH
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 20,   0 ; ASSIST EFFECT_ASSIST
	move EFFECT_NORMAL_HIT,           0, GRASS,    STATUS,   100, 35,   0 ; INGRAIN
	move EFFECT_NORMAL_HIT,         120, FIGHTING, PHYSICAL, 100,  5,   0 ; SUPERPOWER EFFECT_SUPERPOWER
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; MAGIC_COAT
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; RECYCLE
	...
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; YAWN
	...
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100, 35,   0 ; ERUPTION
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; SKILL_SWAP
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; IMPRISON
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; REFRESH
	move EFFECT_NORMAL_HIT,           0, GHOST,    STATUS,   100, 35,   0 ; GRUDGE
	...
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; CAMOUFLAGE
	move EFFECT_NORMAL_HIT,           0, BUG,      STATUS,   100, 35,   0 ; TAIL_GLOW
	move EFFECT_SP_DEF_DOWN_HIT,     70, PSYCHIC,  SPECIAL,  100,  5,  50 ; LUSTER_PURGE
	move EFFECT_SP_DEF_DOWN_HIT,     70, PSYCHIC,  SPECIAL,  100,  5,  50 ; MIST_BALL EFFECT_SP_ATK_DOWN_HIT
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 35,   0 ; FEATHER_DANCE
	move EFFECT_CONFUSE,              0, NORMAL,   STATUS,   100, 20,   0 ; TEETER_DANCE
	move EFFECT_BURN_HIT,            85, FIRE,     PHYSICAL,  90, 10,  10 ; BLAZE_KICK
	move EFFECT_NORMAL_HIT,          40, GROUND,   STATUS,   100, 35,   0 ; MUD_SPORT 
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; COSMIC_POWER
	...
	move EFFECT_NORMAL_HIT,          40, FIGHTING, PHYSICAL, 100, 35,   0 ; SKY_UPPERCUT
	...
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 35,   0 ; BULLET_SEED
	move EFFECT_ALWAYS_HIT,          60, FLYING,   PHYSICAL, 100, 20,   0 ; AERIAL_ACE
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 35,   0 ; ICICLE_SPEAR
	...
	move EFFECT_NORMAL_HIT,           0, FIGHTING, STATUS,   100, 35,   0 ; BULK_UP
	move EFFECT_FLY,                 40, FLYING,   PHYSICAL, 100, 35,   0 ; BOUNCE
	move EFFECT_SPEED_DOWN_HIT,      55, GROUND,   SPECIAL,   95, 15, 100 ; MUD_SHOT
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100, 35,   0 ; POISON_TAIL
	...
	move EFFECT_NORMAL_HIT,           0, WATER,    STATUS,   100, 35,   0 ; WATER_SPORT
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 20,   0 ; CALM_MIND EFFECT_CALM_MIND
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 35,   0 ; LEAF_BLADE
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    SPECIAL,  100, 35,   0 ; DOOM_DESIRE
	move EFFECT_NORMAL_HIT,          40, PSYCHIC,  SPECIAL,  100, 35,   0 ; PSYCHO_BOOST
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 10,   0 ; ROOST EFFECT_ROOST
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; GRAVITY
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; MIRACLE_EYE
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100, 35,   0 ; GYRO_BALL
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; HEALING_WISH
	...
	move EFFECT_NORMAL_HIT,          40, FLYING,   PHYSICAL, 100, 35,   0 ; PLUCK
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 35,   0 ; TAILWIND
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; ACUPRESSURE
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100, 35,   0 ; METAL_BURST
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 35,   0 ; U_TURN
	move EFFECT_NORMAL_HIT,         120, FIGHTING, PHYSICAL, 100,  5,   0 ; CLOSE_COMBAT EFFECT_CLOSE_COMBAT
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100, 35,   0 ; PAYBACK
	move EFFECT_NORMAL_HIT,          60, DARK,     PHYSICAL, 100, 10,   0 ; ASSURANCE EFFECT_ASSURANCE
	move EFFECT_NORMAL_HIT,           0, DARK,     STATUS,   100, 35,   0 ; EMBARGO
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100, 35,   0 ; FLING
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; PSYCHO_SHIFT
	move EFFECT_NORMAL_HIT,           1, NORMAL,   SPECIAL,  100,  5,   0 ; TRUMP_CARD EFFECT_TRUMP_CARD
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; HEAL_BLOCK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 35,   0 ; WRING_OUT 
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; POWER_TRICK
	move EFFECT_NORMAL_HIT,           0, POISON,   STATUS,   100, 35,   0 ; GASTRO_ACID
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; LUCKY_CHANT
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; ME_FIRST 
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; COPYCAT
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; POWER_SWAP
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; GUARD_SWAP
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100, 35,   0 ; PUNISHMENT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; LAST_RESORT
	move EFFECT_NORMAL_HIT,           0, GRASS,    STATUS,   100, 35,   0 ; WORRY_SEED
	move EFFECT_NORMAL_HIT,          70, DARK,     PHYSICAL, 100,  5,   0 ; SUCKER_PUNCH EFFECT_SUCKER_PUNCH
	move EFFECT_NORMAL_HIT,           0, POISON,   STATUS,   100, 35,   0 ; TOXIC_SPIKES
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; HEART_SWAP
	move EFFECT_NORMAL_HIT,           0, WATER,    STATUS,   100, 20, 100 ; AQUA_RING EFFECT_AQUA_RING
	move EFFECT_NORMAL_HIT,           0, ELECTRIC, STATUS,   100, 35,   0 ; MAGNET_RISE
	move EFFECT_NORMAL_HIT,         120, FIRE,     PHYSICAL, 100, 15,  10 ; FLARE_BLITZ EFFECT_FLARE_BLITZ
	move EFFECT_NORMAL_HIT,          40, FIGHTING, PHYSICAL, 100, 35,   0 ; FORCE_PALM
	move EFFECT_ALWAYS_HIT,          80, FIGHTING, SPECIAL,  100, 20,   0 ; AURA_SPHERE
	move EFFECT_NORMAL_HIT,           0, ROCK,     STATUS,   100, 35,   0 ; ROCK_POLISH
	...
	move EFFECT_NORMAL_HIT,          40, WATER,    PHYSICAL, 100, 35,   0 ; AQUA_TAIL
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 35,   0 ; SEED_BOMB
	move EFFECT_FLINCH_HIT,          75, FLYING,   PHYSICAL,  95, 15,  30 ; AIR_SLASH
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 35,   0 ; X_SCISSOR
	...
	move EFFECT_NORMAL_HIT,           0, DARK,     STATUS,   100, 35,   0 ; SWITCHEROO
	...
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 35,   0 ; AVALANCHE
	move EFFECT_PRIORITY_HIT,        40, ICE,      PHYSICAL, 100, 30,   0 ; ICE_SHARD
	move EFFECT_NORMAL_HIT,          40, GHOST,    PHYSICAL, 100, 35,   0 ; SHADOW_CLAW
	move EFFECT_NORMAL_HIT,          40, ELECTRIC, PHYSICAL, 100, 35,   0 ; THUNDER_FANG
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 35,   0 ; ICE_FANG
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    SPECIAL,  100, 35,   0 ; MIRROR_SHOT
	...
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 35,   0 ; DEFOG
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; TRICK_ROOM
	...
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100, 35,   0 ; LAVA_PLUME
	move EFFECT_NORMAL_HIT,         140, GRASS,    SPECIAL,   90,  5,   0 ; LEAF_STORM EFFECT_SELF_SPATK_DN_2_HIT
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 35,   0 ; POWER_WHIP
	move EFFECT_HYPER_BEAM,         150, ROCK,     PHYSICAL,  90,  5,   0 ; ROCK_WRECKER
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100, 35,   0 ; CROSS_POISON
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100, 35,   0 ; GUNK_SHOT
	move EFFECT_FLINCH_HIT,          80, STEEL,    PHYSICAL, 100, 15,  30 ; IRON_HEAD
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100, 35,   0 ; MAGNET_BOMB
	move EFFECT_NORMAL_HIT,          40, ROCK,     PHYSICAL, 100, 35,   0 ; STONE_EDGE 
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 35,   0 ; CAPTIVATE 
	move EFFECT_SPIKES,               0, ROCK,     STATUS,   100, 35,   0 ; STEALTH_ROCK 
	move EFFECT_NORMAL_HIT,           1, GRASS,    SPECIAL,  100, 20,   0 ; GRASS_KNOT EFFECT_GRASS_KNOT
	move EFFECT_NORMAL_HIT,          40, FLYING,   SPECIAL,  100, 35,   0 ; CHATTER  
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 35,   0 ; JUDGEMENT
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 35,   0 ; BUG_BITE
	...
	move EFFECT_NORMAL_HIT,           0, BUG,      STATUS,   100, 35,   0 ; DEFEND_ORDER
	move EFFECT_HEAL,                 0, BUG,      STATUS,   100, 10,   0 ; HEAL_ORDER
	move EFFECT_NORMAL_HIT,          40, ROCK,     PHYSICAL, 100, 35,   0 ; HEAD_SMASH
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 35,   0 ; LUNAR_DANCE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 35,   0 ; CRUSH_GRIP
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100, 35,   0 ; MAGMA_STORM
	move EFFECT_SLEEP,                0, DARK,     STATUS,    80, 10,   0 ; DARK_VOID
	move EFFECT_NORMAL_HIT,          40, GRASS,    SPECIAL,  100, 35,   0 ; SEED_FLARE
	move EFFECT_NORMAL_HIT,          40, GHOST,    SPECIAL,  100, 35,   0 ; OMINOUS_WIND
	move EFFECT_NORMAL_HIT,          40, GHOST,    PHYSICAL, 100, 35,   0 ; SHADOW_FORCE
