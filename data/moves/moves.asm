...
;==========================
	...
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 10,   0 ; UPROAR
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 20,   0 ; STOCKPILE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 10,   0 ; SPIT_UP
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; TRICK
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; ROLE_PLAY
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 15,   0 ; MAGIC_COAT
	...
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100,  5,   0 ; ERUPTION
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; SKILL_SWAP
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; IMPRISON
	...
	move EFFECT_NORMAL_HIT,          40, GROUND,   STATUS,   100, 15,   0 ; MUD_SPORT 
	...
	move EFFECT_SPEED_DOWN_HIT,      60, ROCK,     PHYSICAL,  95, 10, 100 ; ROCK_TOMB
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 20,   0 ; COSMIC_POWER
	...
	move EFFECT_FLINCH_HIT,          80, PSYCHIC,  SPECIAL,  100, 30,  10 ; EXTRASENSORY
	move EFFECT_NORMAL_HIT,          40, FIGHTING, PHYSICAL, 100, 15,   0 ; SKY_UPPERCUT
	...
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 30,   0 ; BULLET_SEED
	move EFFECT_ALWAYS_HIT,          60, FLYING,   PHYSICAL, 100, 20,   0 ; AERIAL_ACE
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 30,   0 ; ICICLE_SPEAR
	...
	move EFFECT_FLY,                 40, FLYING,   PHYSICAL, 100,  5,   0 ; BOUNCE
	move EFFECT_SPEED_DOWN_HIT,      55, GROUND,   SPECIAL,   95, 15, 100 ; MUD_SHOT
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100, 25,   0 ; POISON_TAIL
	move EFFECT_THIEF,               60, NORMAL,   PHYSICAL, 100, 40, 100 ; COVET
	...
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 15,   0 ; LEAF_BLADE
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    SPECIAL,  100,  5,   0 ; DOOM_DESIRE
	move EFFECT_NORMAL_HIT,          40, PSYCHIC,  SPECIAL,  100,  5,   0 ; PSYCHO_BOOST
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 10,   0 ; ROOST EFFECT_ROOST
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100,  5,   0 ; GRAVITY
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 40,   0 ; MIRACLE_EYE
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100,  5,   0 ; GYRO_BALL
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; HEALING_WISH
	move EFFECT_NORMAL_HIT,          65, WATER,    SPECIAL,  100, 10,   0 ; BRINE EFFECT_BRINE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 15,   0 ; NATURAL_GIFT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 10,   0 ; FEINT
	move EFFECT_NORMAL_HIT,          40, FLYING,   PHYSICAL, 100, 20,   0 ; PLUCK
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 30,   0 ; TAILWIND
	move EFFECT_NORMAL_HIT,           0, NORMAL,   STATUS,   100, 30,   0 ; ACUPRESSURE
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100, 10,   0 ; METAL_BURST
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 20,   0 ; U_TURN
	move EFFECT_NORMAL_HIT,         120, FIGHTING, PHYSICAL, 100,  5,   0 ; CLOSE_COMBAT EFFECT_CLOSE_COMBAT
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100, 10,   0 ; PAYBACK
	...
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100, 10,   0 ; FLING
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; PSYCHO_SHIFT
	move EFFECT_NORMAL_HIT,           1, NORMAL,   SPECIAL,  100,  5,   0 ; TRUMP_CARD EFFECT_TRUMP_CARD
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 15,   0 ; HEAL_BLOCK
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100,  5,   0 ; WRING_OUT 
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; POWER_TRICK
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; POWER_SWAP
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; GUARD_SWAP
	move EFFECT_NORMAL_HIT,          40, DARK,     PHYSICAL, 100,  5,   0 ; PUNISHMENT
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100,  5,   0 ; LAST_RESORT
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; HEART_SWAP
	...
	move EFFECT_NORMAL_HIT,          40, FIGHTING, PHYSICAL, 100, 10,   0 ; FORCE_PALM
	move EFFECT_ALWAYS_HIT,          80, FIGHTING, SPECIAL,  100, 20,   0 ; AURA_SPHERE
	move EFFECT_NORMAL_HIT,           0, ROCK,     STATUS,   100, 20,   0 ; ROCK_POLISH
	...
	move EFFECT_NORMAL_HIT,          40, WATER,    PHYSICAL, 100, 10,   0 ; AQUA_TAIL
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 15,   0 ; SEED_BOMB
	move EFFECT_FLINCH_HIT,          75, FLYING,   PHYSICAL,  95, 20,  30 ; AIR_SLASH
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 15,   0 ; X_SCISSOR
	...
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 10,   0 ; AVALANCHE
	move EFFECT_PRIORITY_HIT,        40, ICE,      PHYSICAL, 100, 30,   0 ; ICE_SHARD
	move EFFECT_NORMAL_HIT,          40, GHOST,    PHYSICAL, 100, 15,   0 ; SHADOW_CLAW
	move EFFECT_NORMAL_HIT,          40, ELECTRIC, PHYSICAL, 100, 15,   0 ; THUNDER_FANG
	move EFFECT_NORMAL_HIT,          40, ICE,      PHYSICAL, 100, 15,   0 ; ICE_FANG
	...
	move EFFECT_NORMAL_HIT,          40, STEEL,    SPECIAL,  100, 10,   0 ; MIRROR_SHOT
	...
	move EFFECT_NORMAL_HIT,           0, FLYING,   STATUS,   100, 15,   0 ; DEFOG
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100,  5,   0 ; TRICK_ROOM
	...
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100, 15,   0 ; LAVA_PLUME
	move EFFECT_NORMAL_HIT,         140, GRASS,    SPECIAL,   90,  5,   0 ; LEAF_STORM EFFECT_SELF_SPATK_DN_2_HIT
	move EFFECT_NORMAL_HIT,          40, GRASS,    PHYSICAL, 100, 10,   0 ; POWER_WHIP
	move EFFECT_HYPER_BEAM,         150, ROCK,     PHYSICAL,  90,  5,   0 ; ROCK_WRECKER
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100, 20,   0 ; CROSS_POISON
	move EFFECT_NORMAL_HIT,          40, POISON,   PHYSICAL, 100,  5,   0 ; GUNK_SHOT
	move EFFECT_FLINCH_HIT,          80, STEEL,    PHYSICAL, 100, 15,  30 ; IRON_HEAD
	move EFFECT_NORMAL_HIT,          40, STEEL,    PHYSICAL, 100, 20,   0 ; MAGNET_BOMB
	move EFFECT_NORMAL_HIT,          40, ROCK,     PHYSICAL, 100,  5,   0 ; STONE_EDGE 
	...
	move EFFECT_NORMAL_HIT,          40, FLYING,   SPECIAL,  100, 20,   0 ; CHATTER  
	move EFFECT_NORMAL_HIT,          40, NORMAL,   SPECIAL,  100, 10,   0 ; JUDGEMENT
	move EFFECT_NORMAL_HIT,          40, BUG,      PHYSICAL, 100, 20,   0 ; BUG_BITE
	...
	move EFFECT_NORMAL_HIT,           0, BUG,      STATUS,   100, 10,   0 ; DEFEND_ORDER
	move EFFECT_HEAL,                 0, BUG,      STATUS,   100, 10,   0 ; HEAL_ORDER
	move EFFECT_NORMAL_HIT,          40, ROCK,     PHYSICAL, 100,  5,   0 ; HEAD_SMASH
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100, 10,   0 ; DOUBLE_HIT
	...
	move EFFECT_NORMAL_HIT,           0, PSYCHIC,  STATUS,   100, 10,   0 ; LUNAR_DANCE
	move EFFECT_NORMAL_HIT,          40, NORMAL,   PHYSICAL, 100,  5,   0 ; CRUSH_GRIP
	move EFFECT_NORMAL_HIT,          40, FIRE,     SPECIAL,  100,  5,   0 ; MAGMA_STORM
	move EFFECT_SLEEP,                0, DARK,     STATUS,    80, 10,   0 ; DARK_VOID
	move EFFECT_NORMAL_HIT,          40, GRASS,    SPECIAL,  100,  5,   0 ; SEED_FLARE
	move EFFECT_NORMAL_HIT,          40, GHOST,    SPECIAL,  100,  5,   0 ; OMINOUS_WIND
	move EFFECT_NORMAL_HIT,          40, GHOST,    PHYSICAL, 100,  5,   0 ; SHADOW_FORCE
