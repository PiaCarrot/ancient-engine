...
;==========================
	...
	move EFFECT_SPEED_DOWN_HIT,      50, ROCK,     PHYSICAL,  95, 10, 100 ; ROCK_TOMB
	...
	move EFFECT_NORMAL_HIT,          85, FIGHTING, PHYSICAL, 100, 15,   0 ; SKY_UPPERCUT
	move EFFECT_TRAP_TARGET,         15, GROUND,   PHYSICAL,  85, 15,   0 ; SAND_TOMB
	...
	move EFFECT_FLY,                 85, FLYING,   PHYSICAL, 100,  5,   0 ; BOUNCE
	move EFFECT_SPEED_DOWN_HIT,      55, GROUND,   SPECIAL,   95, 15, 100 ; MUD_SHOT
	move EFFECT_NORMAL_HIT,          50, POISON,   PHYSICAL, 100, 25,   0 ; POISON_TAIL
	...
	move EFFECT_NORMAL_HIT,         140, PSYCHIC,  SPECIAL,   90,  5,   0 ; PSYCHO_BOOST
	...
	move EFFECT_NORMAL_HIT,          60, FIGHTING, PHYSICAL, 100, 10,   0 ; FORCE_PALM
	move EFFECT_ALWAYS_HIT,          91, FIGHTING, SPECIAL,  100, 20,   0 ; AURA_SPHERE
	...
	move EFFECT_NORMAL_HIT,          90, WATER,    PHYSICAL, 100, 10,   0 ; AQUA_TAIL
	...
	move EFFECT_NORMAL_HIT,         100, DRAGON,   PHYSICAL, 100, 10,   0 ; DRAGON_RUSH
	...
	move EFFECT_NORMAL_HIT,          80, GRASS,    SPECIAL,  100, 10,   0 ; ENERGY_BALL
	...
	move EFFECT_NORMAL_HIT,          60, ICE,      PHYSICAL, 100, 10,   0 ; AVALANCHE
	move EFFECT_PRIORITY_HIT,        40, ICE,      PHYSICAL, 100, 30,   0 ; ICE_SHARD
	move EFFECT_NORMAL_HIT,          70, GHOST,    PHYSICAL, 100, 15,   0 ; SHADOW_CLAW
	move EFFECT_NORMAL_HIT,          65, ELECTRIC, PHYSICAL, 100, 15,   0 ; THUNDER_FANG
	move EFFECT_NORMAL_HIT,          65, ICE,      PHYSICAL, 100, 15,   0 ; ICE_FANG
	...
	move EFFECT_NORMAL_HIT,          65, STEEL,    SPECIAL,  100, 10,   0 ; MIRROR_SHOT
	...
	move EFFECT_NORMAL_HIT,         120, GRASS,    PHYSICAL, 100, 10,   0 ; POWER_WHIP
	move EFFECT_HYPER_BEAM,         150, ROCK,     PHYSICAL,  90,  5,   0 ; ROCK_WRECKER
	move EFFECT_NORMAL_HIT,          70, POISON,   PHYSICAL, 100, 20,   0 ; CROSS_POISON
	move EFFECT_NORMAL_HIT,         120, POISON,   PHYSICAL, 100,  5,   0 ; GUNK_SHOT
	move EFFECT_FLINCH_HIT,          80, STEEL,    PHYSICAL, 100, 15,  30 ; IRON_HEAD
	move EFFECT_NORMAL_HIT,          60, STEEL,    PHYSICAL, 100, 20,   0 ; MAGNET_BOMB
	move EFFECT_NORMAL_HIT,         100, ROCK,     PHYSICAL, 100,  5,   0 ; STONE_EDGE 
	...
	move EFFECT_NORMAL_HIT,          60, FLYING,   SPECIAL,  100, 20,   0 ; CHATTER  
	...
	move EFFECT_NORMAL_HIT,         150, ROCK,     PHYSICAL, 100,  5,   0 ; HEAD_SMASH
	move EFFECT_NORMAL_HIT,          35, NORMAL,   PHYSICAL, 100, 10,   0 ; DOUBLE_HIT
	...
	move EFFECT_NORMAL_HIT,         120, FIRE,     SPECIAL,  100,  5,   0 ; MAGMA_STORM
	move EFFECT_SLEEP,                0, DARK,     STATUS,    80, 10,   0 ; DARK_VOID
	move EFFECT_NORMAL_HIT,         120, GRASS,    SPECIAL,  100,  5,   0 ; SEED_FLARE
	move EFFECT_NORMAL_HIT,          60, GHOST,    SPECIAL,  100,  5,   0 ; OMINOUS_WIND
	move EFFECT_NORMAL_HIT,         120, GHOST,    PHYSICAL, 100,  5,   0 ; SHADOW_FORCE
